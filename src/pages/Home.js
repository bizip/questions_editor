    ...
    <section className='landing__page'>
      ...
      <div className='choice_container'>
        ...
        <div className='choice'>
          ...
          <Link to='/regulatoryafairs' className="choice__link" eventKey="disabled">Regulatory Affairs</Link>
          <Link to='/pharmacovigilance' className="choice__link" eventKey="disabled">Pharmacovigilance</Link>
        </div>
        </div>
        </div>
        <Footer />
